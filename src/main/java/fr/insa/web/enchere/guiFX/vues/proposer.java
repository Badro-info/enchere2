...
//        this.add(new Label("date de fin"), 0, 4);
//        this.tfdatefin = new Timestamp();
//        this.add(this.tfdatefin, 1, 4);
//        this.add(new Label("datedebut"), 0, 5);
//        this.tfdatedebut = new Timestamp();
//        this.add(this.tfdatedebut, 1, 5);
...
//            Timestamp datefin = tfdatefin.getTime();
//            int prixbase = tfprixbase.getText();
//            Timestamp datedebut = tfdebut.getTime();
//            String Titre = tftitre.getText();
//            String Description = tfdescription.getText();
//            int Categorie = tfcategorie.getText();
//            int ProposerPar = tfproposerpar.getText();
//            try {
